...
// const whitelist = ['http://localhost:4000', 'http://192.168.100.19:3000'];
// const corsOptions = {
//   origin: function (origin, callback) {
//     if (!origin) {
//       //for bypassing postman req with  no origin
...
app.use(xss());
// app.use(express.static(path.join(__dirname, '../backbookserver/build')));

// app.get("*",(req,res)=>{
// res.sendFile(path.resolve(__dirname, '../backbookserver/build/index.html'))
